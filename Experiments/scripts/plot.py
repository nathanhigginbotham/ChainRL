...
def PlotNetworkAlone(env_string, filepath):
...
def plot_training_curves(env_name, model_names, xlims, ylims, filepath):
...
#models = [('PPO', 'default'), ('TRPO', 'default'), ('RecurrentPPO', 'default'), ('A2C', 'default'), ('TQC', 'default'), ('ARS', 'default')]

#plot_training_curves('NetworkManagement-v1-100', models, (1, 5), (-2500, 2500))
